      ...
      <div className="col-lg-8 col-sm-12 d-flex flex-row mx-auto text-center p-1  home-hero ">
        <div className="my-4">
          ...
          <h3 className="text-white">
            “Connecting with others gives us a sense of inclusion, connection,
            interaction, safety, and community. Your vibe attracts your tribe,
            so if you want to attract positive and healthy relationships, be
            one! Staying connected and getting reconnected feeds the flow of
            goodness which empowers our humanity.”
            <span className="text-warning"> - Susan C. Young</span>
          </h3>
        </div>
      </div>
      <br></br>
