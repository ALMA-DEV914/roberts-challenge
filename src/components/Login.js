...
function Login() {
  ...
  return (
    <div className='container text-white login'>
          ...
          <h2>Login Here</h2>
              <label className='name p-1'>Enter Username</label><br></br>
              <input type='name' placeholder='Username' value={name} onChange={(event) => setName(event.target.value)}/><br></br>
        
              <label className='email p-1'>Enter Email</label><br></br>
              <input type='email' placeholder='Email' value={email} onChange={(event) => setEmail(event.target.value)} /><br></br>

              <label className='password p-1'>Create Password</label><br></br>
              <input className='password'placeholder='********' value={password} onChange={(event) => setPassword(event.target.value)}/><br></br><br></br>
